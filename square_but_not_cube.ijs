...
Note 'Example Usage:'
   I. isSqNotCube i.1090      NB. If we know the upper limit required to get first 30
4 9 16 25 36 49 81 100 121 144 169 196 225 256 289 324 361 400 441 484 529 576 625 676 784 841 900 961 1024 1089
   30 isSqNotCube getFirst 0  NB. otherwise to iteratively build list until first 30 found
4 9 16 25 36 49 81 100 121 144 169 196 225 256 289 324 361 400 441 484 529 576 625 676 784 841 900 961 1024 1089
)

isInt=: = <.          NB. are numbers integers
sqrcube=: 2 3 %:/ ]   NB. table of 2nd and 2rd roots of y
isSqNotCube=: [: *./ 0 1 |@:- [: isInt sqrcube  NB. is y a squared and not a cubed integer

notEnough=: > +/      NB. is left arg greater than sum of right arg
getIdx=: {. I.        NB. get first x indicies of boolean y
